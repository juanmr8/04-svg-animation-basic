...
const BottomLine = () => {
  ...
  const setPath = (value: number) => {
    ...
    path.current?.setAttribute(
      'd',
      `M0 50 Q${innerWidth * x} ${50 + value}, ${innerWidth} 50`
    );
  };
  ...
  return (
    <div className='line relative bottom-[40px] mb-[20px] h-[1px] w-[100%]'>
      <div
        ...
        className='box absolute top-[-20px] left-0 z-10 h-[40px] w-full hover:top-[-75px] hover:h-[150px]'
      />
      <svg className='absolute top-[-50px] w-full' height='100'>
